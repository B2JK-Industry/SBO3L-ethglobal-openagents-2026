...
pub enum ResolveError {
    ...
    UnknownName(String),
    #[error("missing mandate:{0} text record on {1}")]
...
pub struct EnsRecords {
    #[serde(rename = "mandate:agent_id")]
    pub agent_id: String,
    #[serde(rename = "mandate:endpoint")]
    pub endpoint: String,
    #[serde(rename = "mandate:policy_hash")]
    pub policy_hash: String,
    #[serde(rename = "mandate:audit_root")]
    pub audit_root: String,
    #[serde(rename = "mandate:receipt_schema")]
...
/// Resolve an ENS-like name to Mandate text records.
