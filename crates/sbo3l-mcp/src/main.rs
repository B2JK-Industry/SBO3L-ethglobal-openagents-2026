...
//! them through the in-process tool catalogue (`sbo3l_mcp::dispatch`),
...
//! pipes; see `crates/sbo3l-mcp/tests/stdio_jsonrpc.rs`.

use std::io::{BufRead, Write};
use std::sync::Arc;

use sbo3l_mcp::{dispatch_to_response, jsonrpc, ServerContext};
