...
- **Same capsule re-verified in browser:** drag into https://sbo3l-marketing.vercel.app/proof — WASM verifier runs offline checks; tampering with `tx_hash` → `capsule.live_evidence_mismatch`
