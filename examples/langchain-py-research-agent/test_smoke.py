...
from sbo3l_langchain_demo.tools import build_sbo3l_pay_func
...
APRP = json.dumps(
    {"agent_id": "research-agent-01", "task_id": "demo-langchain-py-1", "intent": "purchase_api_call"}
)
...
def test_smoke_module_importable() -> None:
    from sbo3l_langchain_demo import smoke
