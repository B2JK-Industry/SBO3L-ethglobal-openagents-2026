/**
 * `@sbo3l/modal` — SBO3L adapter for the Modal agent / API surface.
 *
 ...
 *
 *   // Wire `tool.descriptor` into Modal's tool registry; pair
 *   // each emitted tool call with `runSbo3lModalGate`.
 *   ```
 */
...
/** APRP v1 input schema for Modal's tool descriptor. Hand-authored — no schema-gen dep. */
...
export interface SBO3LModalTool {
...
export function sbo3lModalGate(options: SBO3LToolOptions): SBO3LModalTool {
...
export async function runSbo3lModalGate(
  tool: SBO3LModalTool,
  call: ModalToolCall,
): Promise<ModalToolResult> {
