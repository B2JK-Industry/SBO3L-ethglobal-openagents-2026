...
- Initial release. SBO3L adapter for the Perplexity agent / API surface.
- `sbo3lPerplexityTool({ client })` returns `{ name, descriptor, execute }`.
- `runSbo3lPerplexityToolCall(tool, call)` converts a framework tool call into a structured envelope; never re-throws.
...
[1.2.0]: https://github.com/B2JK-Industry/SBO3L-ethglobal-openagents-2026/releases/tag/perplexity-v1.2.0
