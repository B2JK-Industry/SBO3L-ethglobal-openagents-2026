...
>
> **What ships at v1.2.2.** Ten Rust crates on crates.io. TypeScript SDK on npm. Python SDK on PyPI. Eight framework integrations (LangChain TS/Py, CrewAI, AutoGen, ElizaOS, LlamaIndex, Vercel AI, LangGraph) plus 19 marketplace SDK adapters on npm (LLM providers + agent platforms — `@sbo3l/anthropic`, `@sbo3l/openai-assistants`, `@sbo3l/cohere-tools`, `@sbo3l/perplexity`, `@sbo3l/together`, `@sbo3l/replicate`, `@sbo3l/letta`, `@sbo3l/mastra`, `@sbo3l/modal`, `@sbo3l/inngest`, `@sbo3l/e2b`, `@sbo3l/agentforce`, `@sbo3l/copilot-studio`, `@sbo3l/superagi`, `@sbo3l/babyagi`, `@sbo3l/autogpt`, `@sbo3l/anthropic-computer-use`, `@sbo3l/langflow`, `@sbo3l/vellum`); **26 published `@sbo3l/*` npm packages total** (verified via `npm search @sbo3l`). Docker compose. Marketing site, docs site, CCIP-Read gateway. ENS mainnet apex. Phase 1 exit gate green: 977/977 cargo tests, 13/13 demo gates, 26/0/1 production-shaped runner.
